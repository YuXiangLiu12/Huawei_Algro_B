...
report=cell2table(rows,'VariableNames',{'Db_scale','case_name','status','V_RMSE','T_RMSE_K','lambda_aCL_end'});
writetable(report,fullfile(root,'results','q1_v05','transport_probe.csv'));disp(report);
end
